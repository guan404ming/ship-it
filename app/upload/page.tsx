...
function UploadContent() {
  ...
  const [fileImportType, setFileImportType] = React.useState<string | null>(null);
  const [manualImportType, setManualImportType] = React.useState<string | null>(null);
  ...
  // 處理檔案匯入類型選擇
  const handleFileImportTypeChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    setFileImportType(event.target.value);
  };
  
  // Handler for manual import type selection
  const handleManualImportTypeChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    setManualImportType(event.target.value)
  }
  
  // Mock import history data
  const [importHistory] = React.useState<ImportHistory[]>([
    { id: "IMP2024001", date: "2024-12-02 09:15", fileName: "1202出貨紀錄.csv", recordCount: 50, status: "部份成功" },
    { id: "IMP2024002", date: "2024-12-05 09:15", fileName: "1205出貨紀錄.csv", recordCount: 150, status: "失敗" },
    { id: "IMP2024003", date: "2024-12-30 09:15", fileName: "1230出貨紀錄.csv", recordCount: 250, status: "成功" },
    { id: "IMP2025001", date: "2025-01-22 09:15", fileName: "0122出貨紀錄.csv", recordCount: 10, status: "成功" },
    { id: "IMP2025002", date: "2025-02-24 09:15", fileName: "0224出貨紀錄.csv", recordCount: 150, status: "成功" },
  ])
  ...
  const validateQuantity = (value: string) => {
    ...
    if (isNaN(numberValue) || !Number.isInteger(numberValue) || numberValue <= 0 || value.includes(".")) {
                    ...
                    <div className="flex flex-col justify-between gap-4">
                      <div className="flex gap-2 mb-2">
                        <div className="flex items-center">
                          ...
                          />
                          <Label htmlFor="batch-import" className="ml-2">批量匯入</Label>
                        </div>
                        <div className="flex items-center">
                          <Input 
                            type="radio" 
                          ...
                          />
                          <Label htmlFor="single-import" className="ml-2">庫存匯入</Label>
                        </div>
                      </div>
                      ...
                      <div className="border border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center h-40 cursor-pointer hover:bg-gray-50">
                        <div className="flex flex-col items-center justify-center py-6">
                          ...
                          <p className="text-xs text-muted-foreground">支援 .xlsx, .csv 檔案格式</p>
                        </div>
                      </div>
                      ...
                      <Button className="w-full" type="submit">確認上傳</Button>
                    </div>
                  </CardContent>
                </Card>
                    ...
                    <div className="flex flex-col justify-between gap-4">
                      <div className="flex gap-2 mb-2">
                        <div className="flex items-center">
                          ...
                          />
                          <Label htmlFor="batch-manual" className="ml-2">批量匯入</Label>
                        </div>
                        <div className="flex items-center">
                          <Input 
                            type="radio" 
                          ...
                          />
                          <Label htmlFor="single-manual" className="ml-2">庫存匯入</Label>
                        </div>
                      </div>
                      ...
                      <div className="grid gap-3">
                        <div className="grid gap-1.5">
                          ...
                          <Input id="product-code" placeholder="請輸入貨品編號" />
                        </div>
                        <div className="grid gap-1.5">
                        ...
                        <div className="grid gap-1.5">
                          ...
                          <Input 
                            ...
                            className={`${manualImportType === "single" ? "bg-gray-100 cursor-not-allowed" : ""} ${priceError ? "border-red-500" : ""}`}
                            value={price}
                      ...
                      <Button className="w-full" type="submit">確認輸入</Button>
                    </div>
                  </CardContent>
                </Card>
              </div>
                ...
                <div className="grid gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">所需欄位包含: 商品編號、規格資訊、數量、批號。</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">上傳檔案後，系統將自動解析資料格式，若有疑問請聯繫系統管理員。</p>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <TableBody>
                      {importHistory.map((record) => (
                        <TableRow key={record.id} >
                          ...
                          <TableCell className="text-right font-mono">{record.recordCount}</TableCell>
                          <TableCell>
                            <span 
